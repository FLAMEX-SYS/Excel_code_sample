...
date_range_columns = [
    ...
    'pastdue 0-30 days exceptions removed', 'pastdue 30-60 days exceptions removed', 'pastdue 60-90 days exceptions removed', 'pastdue >90 days exceptions removed'
]
...
# Calculate past due ranges for vulnerabilities with no exceptions
for index, row in extracted_data.iterrows():
    if pd.isnull(row['Exception Expiration']):
        due_date_ranges = check_date_ranges(row['Due Date'], current_date)
        extracted_data.at[index, 'pastdue 0-30 days exceptions removed'] = due_date_ranges['0-30']
        extracted_data.at[index, 'pastdue 30-60 days exceptions removed'] = due_date_ranges['30-60']
        extracted_data.at[index, 'pastdue 60-90 days exceptions removed'] = due_date_ranges['60-90']
        extracted_data.at[index, 'pastdue >90 days exceptions removed'] = due_date_ranges['>90']
...
aggregated_data = extracted_data.groupby('hostname').agg({
    ...
    'pastdue 0-30 days exceptions removed': 'sum',
    'pastdue 30-60 days exceptions removed': 'sum',
    'pastdue 60-90 days exceptions removed': 'sum',
    'pastdue >90 days exceptions removed': 'sum',
    'has_exception': 'sum',
    'is_closed': 'sum',
    'high_cvss': 'sum'
}).reset_index()
...
aggregated_data = aggregated_data.rename(columns={
    ...
    'pastdue 0-30 days exceptions removed': 'pastdue 0-30 days exceptions removed count',
    'pastdue 30-60 days exceptions removed': 'pastdue 30-60 days exceptions removed count',
    'pastdue 60-90 days exceptions removed': 'pastdue 60-90 days exceptions removed count',
    'pastdue >90 days exceptions removed': 'pastdue >90 days exceptions removed count',
